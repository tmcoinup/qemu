#!/usr/bin/env bash
# Install the root-owned V100/R570/R580 heterogeneous-mode boot and reset guard.
set -euo pipefail
...
{
    echo '[Unit]'
    echo 'Description=VMate V100 heterogeneous vGPU mode guard'
...
echo "V100 mixed-size guard installed for $bdf"
