...
[CmdletBinding()]
param(
    [string]$AuditScriptPath = 'C:\VMateLab\Capture-VMateManagerPopup.ps1',
...
$taskName = 'VMate-Sample-Manager-Popup-Audit'
...
try {
    ...
    if (-not (Test-Path -LiteralPath $OutputPath -PathType Leaf)) {
        ...
        throw "popup audit timed out; task result $($task.LastTaskResult)."
    }
    ...
    [pscustomobject][ordered]@{
        ...
        PopupForeground = [string]$document.PopupForeground
