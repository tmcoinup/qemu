# Tesla V100：R570/18.4 生产结论与版本边界

V100 新主机统一采用 vGPU 18.4/R570：host `570.172.07`、Windows guest `573.48`
（`32.0.15.7348`）、Ubuntu GA `6.8.*-generic`。全新安装入口是
[`G11-V100-VGPU18.4-FRESH-INSTALL.md`](G11-V100-VGPU18.4-FRESH-INSTALL.md)。

R535/16.4 继续兼容既有全 1Q 环境；R580/19.5 只保留 name-only 和故障定位记录。
...
| --- | --- | --- | --- |
| R570，推荐 | `570.172.07` / 正式签名 `573.48` | mixed；`V100*-1Q` + `V100*-2Q`；460-byte ABI；RAM_TYPE 只允许精确 1024/2048 MiB | 新 V100 生产主路径 |
| R535，兼容 | `535.161.05` / 正式签名 `538.33` | equal 1024；仅 `V100*-1Q`；436-byte ABI | 既有全 1Q 主机、旧 RTX 2080 |
