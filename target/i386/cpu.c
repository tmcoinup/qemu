...
/*
 * Consumer LGA2011 cache layouts used by the first-party Core i7 models
 * below.  The private 32 KiB L1 and 256 KiB L2 caches are shared by all
 * five SKUs; the inclusive package LLC follows each retail part exactly.
 */
static const CPUCaches desktop_snb_ivb_e_10m_cache_info = {
    .l1d_cache = &(CPUCacheInfo) {
        .type = DATA_CACHE,
        .level = 1,
        .size = 32 * KiB,
...
static const X86CPUDefinition builtin_x86_defs[] = {
    ...
    {
        /* Consumer Sandy Bridge-E Core i7-3820, 4 cores / 8 threads. */
        .name = "Core-i7-3820",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        .family = 6,
        ...
        .cache_info = &desktop_snb_ivb_e_10m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
        }
    ...
    {
        /* Consumer Sandy Bridge-E Core i7-3930K, 6 cores / 12 threads. */
        .name = "Core-i7-3930K",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        .family = 6,
    ...
    {
        /* Consumer Ivy Bridge-E Core i7-4820K, 4 cores / 8 threads. */
        .name = "Core-i7-4820K",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        .family = 6,
    ...
    {
        /* Consumer Ivy Bridge-E Core i7-4930K, 6 cores / 12 threads. */
        .name = "Core-i7-4930K",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        .family = 6,
    ...
    {
        /* Consumer Ivy Bridge-E Core i7-4960X, 6 cores / 12 threads. */
        .name = "Core-i7-4960X",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        .family = 6,
