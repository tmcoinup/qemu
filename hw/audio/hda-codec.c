 ...
 * virtualization tell. Pose as a common Realtek codec (0x10ec); together
 * with the guest-side controller FriendlyName rewrite this avoids linking
 * the audio codec identity back to QEMU/virtio.
 */
