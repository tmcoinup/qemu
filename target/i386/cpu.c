...
/*
 * Desktop Haswell cache layout used by the Pentium G3220 and Core i3-4130.
 * Both parts have private 32 KiB L1 caches, a private 256 KiB L2 and a
 * 3 MiB, 12-way last-level cache shared by the package.
 */
static const CPUCaches desktop_hsw_3m_cache_info = {
    .l1d_cache = &(CPUCacheInfo) {
        .type = DATA_CACHE,
        .level = 1,
        .size = 32 * KiB,
...
/* Desktop Haswell cache layout used by the Core-i5-4460/4570/4590 models. */
...
/* Desktop Haswell cache layout used by the Core-i7-4790 model. */
static const CPUCaches desktop_hsw_8m_cache_info = {
    .l1d_cache = &(CPUCacheInfo) {
        .type = DATA_CACHE,
        .level = 1,
        .size = 32 * KiB,
...
/*
 * Desktop Sandy/Ivy Bridge-E cache layout used by Core-i7-3820/4820K.
 * Both SKUs have private 32 KiB data/instruction L1 caches, private 256 KiB
 * L2 caches and one package-shared 10 MiB, 20-way inclusive LLC.
 */
static const CPUCaches desktop_snb_e_10m_cache_info = {
    .l1d_cache = &(CPUCacheInfo) {
        .type = DATA_CACHE,
        .level = 1,
        .size = 32 * KiB,
...
/*
 * Desktop Sandy/Ivy Bridge-E cache layout used by Core-i7-3930K/4930K.  Each
 * of its six cores has private 32 KiB data/instruction L1 and 256 KiB L2
 * caches; the die exposes one package-shared 12 MiB, 16-way inclusive LLC.
 */
static const CPUCaches desktop_snb_ivb_e_12m_cache_info = {
    .l1d_cache = &(CPUCacheInfo) {
        .type = DATA_CACHE,
        .level = 1,
        .size = 32 * KiB,
...
/*
 * Desktop Ivy Bridge-E cache layout used by Core-i7-4960X.  Its private
 * caches match the other six-core LGA2011 parts, while the package-shared
 * inclusive LLC exposes the retail SKU's complete 15 MiB, 20-way layout.
 */
static const CPUCaches desktop_ivb_e_15m_cache_info = {
    .l1d_cache = &(CPUCacheInfo) {
        .type = DATA_CACHE,
        .level = 1,
        .size = 32 * KiB,
...
static const X86CPUDefinition builtin_x86_defs[] = {
    ...
    {
        /*
         * Desktop Sandy Bridge-E (LGA2011), family 6 model 45 stepping 7.
         * This first-party model keeps KVM enforce=on while presenting the
         * retail 4C/8T i7-3820 identity and its 10 MiB LLC.
         */
        .name = "Core-i7-3820",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .features[FEAT_6_EAX] =
            CPUID_6_EAX_ARAT,
        .xlevel = 0x80000008,
        .model_id = "Intel(R) Core(TM) i7-3820 CPU @ 3.60GHz",
        .cache_info = &desktop_snb_e_10m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
        }
    },
    {
        /*
         * Desktop Sandy Bridge-E (LGA2011), family 6 model 45 stepping 7.
         * The retail i7-3930K keeps the i7-3820 instruction contract while
         * exposing six cores, twelve threads and its 12 MiB inclusive LLC.
         */
        .name = "Core-i7-3930K",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .cache_info = &desktop_snb_ivb_e_12m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
        }
    ...
    {
        /*
         * Desktop Ivy Bridge-E (LGA2011), family 6 model 62 stepping 4.
         * It adds the reviewed Ivy Bridge instruction set and retains the
         * retail i7-4820K 10 MiB, 20-way LLC identity.
         */
        .name = "Core-i7-4820K",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .features[FEAT_6_EAX] =
            CPUID_6_EAX_ARAT,
        .xlevel = 0x80000008,
        .model_id = "Intel(R) Core(TM) i7-4820K CPU @ 3.70GHz",
        .cache_info = &desktop_snb_e_10m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
    ...
    },
    {
        /*
         * Desktop Ivy Bridge-E (LGA2011), family 6 model 62 stepping 4.
         * This first-party model presents the retail 6C/12T i7-4930K and its
         * 12 MiB, 16-way LLC while retaining the reviewed Ivy Bridge feature
         * contract used by Core-i7-4820K.
         */
        .name = "Core-i7-4930K",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .features[FEAT_6_EAX] =
            CPUID_6_EAX_ARAT,
        .xlevel = 0x80000008,
        .model_id = "Intel(R) Core(TM) i7-4930K CPU @ 3.40GHz",
        .cache_info = &desktop_snb_ivb_e_12m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
    ...
    },
    {
        /*
         * Desktop Ivy Bridge-E (LGA2011), family 6 model 62 stepping 4.
         * The Extreme Edition i7-4960X shares the reviewed Ivy Bridge-E
         * feature contract and exposes its complete 15 MiB, 20-way LLC.
         */
        .name = "Core-i7-4960X",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .features[FEAT_6_EAX] =
            CPUID_6_EAX_ARAT,
        .xlevel = 0x80000008,
        .model_id = "Intel(R) Core(TM) i7-4960X CPU @ 3.60GHz",
        .cache_info = &desktop_ivb_e_15m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
        }
    ...
    {
        /*
         * Desktop Haswell Pentium (LGA1150), family 6 model 60 stepping 3.
         * G3220 does not expose AES, AVX/AVX2, BMI1/2, F16C or FMA.  This
         * matches the reviewed V-11 Haswell-v4 override while making the
         * contract enforceable as a first-party model in G-11.
         */
        ...
        .features[FEAT_1_EDX] =
            ...
            CPUID_DE | CPUID_FP87,
        .features[FEAT_1_ECX] =
            CPUID_EXT_XSAVE | CPUID_EXT_POPCNT | CPUID_EXT_X2APIC |
            CPUID_EXT_SSE42 | CPUID_EXT_SSE41 | CPUID_EXT_CX16 |
            CPUID_EXT_SSSE3 | CPUID_EXT_PCLMULQDQ | CPUID_EXT_SSE3 |
            CPUID_EXT_TSC_DEADLINE_TIMER | CPUID_EXT_MOVBE | CPUID_EXT_PCID |
            CPUID_EXT_RDRAND,
        .features[FEAT_8000_0001_EDX] =
            CPUID_EXT2_LM | CPUID_EXT2_RDTSCP | CPUID_EXT2_NX |
            CPUID_EXT2_SYSCALL,
        ...
        .features[FEAT_6_EAX] =
            CPUID_6_EAX_ARAT,
        .xlevel = 0x80000008,
        .model_id = "Intel(R) Pentium(R) CPU G3220 @ 3.00GHz",
        .cache_info = &desktop_hsw_3m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
        }
    ...
    {
        /*
         * Desktop Haswell Core i3 (LGA1150), family 6 model 60 stepping 3.
         * The i3-4130 exposes the reviewed non-TSX Haswell instruction set
         * and its retail 3 MiB last-level cache.
         */
        .name = "Core-i3-4130",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
    ...
    {
        /*
         * Desktop Haswell Refresh (LGA1150), family 6 model 60 stepping 3.
         * The i5-4460 uses the reviewed non-TSX Haswell instruction set and
         * the same 6 MiB last-level cache layout as the i5-4570/4590.
         */
        .name = "Core-i5-4460",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .features[FEAT_6_EAX] =
            CPUID_6_EAX_ARAT,
        .xlevel = 0x80000008,
        .model_id = "Intel(R) Core(TM) i5-4460 CPU @ 3.20GHz",
    ...
    {
        /*
         * Desktop Haswell (LGA1150), family 6 model 60 stepping 3.
         * The i5-4570 has the same reviewed CPUID/cache contract as the
         * i5-4590 while exposing its own retail brand string.  Keeping it as
         * a first-party model lets KVM enforce the requested feature set
         * instead of constructing an unchecked model-id override at launch.
         */
        .name = "Core-i5-4570",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
    ...
    },
    {
        /*
         * Desktop Haswell (LGA1150), family 6 model 60 stepping 3.
         * Intended as a first-party brand target that matches a retail
         * i5-4590 more closely than the generic "Haswell" model.
         */
        .name = "Core-i5-4590",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
    ...
    },
    {
        /*
         * Desktop Haswell Refresh (LGA1150), family 6 model 60 stepping 3.
         * The i7-4790 uses the reviewed non-TSX Haswell instruction set and
         * its retail 8 MiB, 16-way last-level cache layout.
         */
        .name = "Core-i7-4790",
        .level = 0xd,
        .vendor = CPUID_VENDOR_INTEL,
        ...
        .cache_info = &desktop_hsw_8m_cache_info,
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            { /* end of list */ }
        }
    ...
    {
        /*
         * Desktop Skylake-S (LGA1151), family 6 model 94 stepping 3.
         * Matches a retail i5-6500; shares feature bits with the generic
         * "Skylake-Client" model but presents the i5-6500 brand string.
         */
        .name = "Core-i5-6500",
        .level = 0x16,
        .vendor = CPUID_VENDOR_INTEL,
    ...
    {
        /*
         * Desktop Coffee Lake-S (LGA1151 300-series), family 6 model 158
         * stepping 11. Matches a retail i3-8100. Adds PKU (protection keys)
         * over Skylake-Client.
         */
        .name = "Core-i3-8100",
        .level = 0x16,
    ...
    },
    {
        ...
        .features[FEAT_SVM] =
            CPUID_SVM_NPT | CPUID_SVM_NRIPSAVE,
        /* Invariant TSC; Summit Ridge has APM_INVTSC */
        .features[FEAT_8000_0007_EDX] =
            CPUID_APM_INVTSC,
        .xlevel = 0x8000001E,
                   ...
                   uint32_t *ecx, uint32_t *edx)
{
    ...
    case 0x16:
        /*
         * Processor Frequency Information (Intel SDM Vol 2). All values MHz,
         * bits 31:16 reserved. Default fills derived from tsc-freq so OVMF
         * status line and Windows WMI CurrentClockSpeed stay consistent with
         * the brand string. Host support for leaf 0x16 is Skylake+, so we
         * only return non-zero when the CPU model advertises level >= 0x16.
         */
        *eax = *ebx = *ecx = *edx = 0;
        if (env->cpuid_level >= 0x16 && env->tsc_khz) {
            uint32_t mhz = (uint32_t)(env->tsc_khz / 1000);
            *eax = mhz & 0xFFFF;           /* base (non-turbo) */
            *ebx = mhz & 0xFFFF;           /* max turbo — same as base */
            *ecx = 100 & 0xFFFF;           /* reference / bus clock */
        }
        break;
    case 0x1D: {
        /* AMX TILE */
...
void x86_cpu_expand_features(X86CPU *cpu, Error **errp)
{
    ...
    /*
     * -cpu ...,x-hv-stealth=on asks us to hide every obvious "I am a
     * hypervisor" marker. Done here (after user properties are parsed
     * and after x86_cpu_load_def has force-set the HYPERVISOR bit) so
     * it beats every earlier mutation. kvm=off separately disables the
     * KVM paravirt signature leaf (0x40000000), so a stealth guest gets
     * a CPUID profile that matches a real host.
     */
    if (cpu->stealth_hypervisor) {
        env->features[FEAT_1_ECX] &= ~CPUID_EXT_HYPERVISOR;
        env->user_features[FEAT_1_ECX] |= CPUID_EXT_HYPERVISOR;
    }
...
static const Property x86_cpu_properties[] = {
    ...
    DEFINE_PROP_BOOL("x-hv-stealth", X86CPU, stealth_hypervisor, false),
