...
QUICK_TESTS = (
    ...
    "test_windows_gpup_host.sh",
    "test_windows_gpup_amd_support.sh",
    "test_windows_gpup_clone.sh",
    "test_windows_gpup_client_inventory.sh",
    "test_windows_gpup_vm_configuration.sh",
    "test_windows_gpup_partition.sh",
    "test_windows_gpup_driverstore.sh",
    "test_windows_gpup_display.sh",
    "test_windows_hyperv_firmware_identity.sh",
    "test_windows_hyperv_identity_boot.sh",
    "test_windows_hyperv_host_identity_extension.sh",
    "test_windows_hyperv_compute_profile.sh",
    "test_windows_hyperv_cpuid_cold_start.sh",
    "test_windows_hyperv_gpup_cold_start_isolation.sh",
    "test_windows_hyperv_enhanced_session.sh",
    "test_windows_hyperv_rdp_connection.sh",
    "test_windows_hyperv_display_topology.sh",
    "test_windows_hyperv_metadata_exchange.sh",
    "test_windows_hyperv_input.sh",
    "test_windows_hyperv_network_identity.sh",
    "test_windows_gpup_hardware_identity.sh",
    "test_windows_gpup_guest_identity.sh",
    "test_windows_gpup_hardware_profile.sh",
    "test_windows_gpup_hardware_reprofile.sh",
    "test_windows_gpup_detection_parity.sh",
    "test_windows_gpup_reference_compatibility.sh",
    "test_windows_gpup_workflow.sh",
    "test_windows_p11_host_environment.sh",
