...
[vgpu-clone] PASS / private Sysprep clone
  ...
  Guest Lite:  pinned 2.6.8 / MpsSvc Automatic/Running / clone fast path / Game Mode / Game DVR off / NVIDIA max performance / DNF High-on-launch / stale Temp cleaned / reviewed background processes stopped / microphone access disabled / audio muted / automatic
...
Guest Lite 2.6.8（母盘封装前必须手工关闭篡改防护）、安装该 VM
