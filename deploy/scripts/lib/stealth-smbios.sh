...
stealth_smbios_args() {
    ...
    t17="type=17,loc_pfx=DIMM_%C2,bank=P0 CHANNEL %C,manufacturer=$(_e "$MEM_MFR"),serial=${MEM_SERIAL}|${mem_serial2},asset=9876543210,part=$(_e "$mem_part"),speed=$mem_speed,memtype=$mem_type,typedetail=0x80,width=64,totalwidth=64,rank=1,voltage=$mem_voltage"
