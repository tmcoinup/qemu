...
trap 'rm -rf -- "$tmp"' EXIT
fixture="$tmp/fixture"
mkdir -p "$fixture/deploy/lib" "$fixture/image/vms/instances/vm456"
...
conf="$fixture/image/vms/instances/vm456/vm.conf"
result="$tmp/result"
run_dispatcher() {
    env -u VM_ROOT -u VM_INSTANCES_DIR -u VM_CONFIG_DIR -u VM_DISK_DIR \
        -u VM_BASE_DIR -u VM_NVRAM_DIR -u STAGE_DIR \
...
max_conf="$fixture/image/vms/instances/vm2147483647/vm.conf"
