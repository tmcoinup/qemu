...
VMATE_RUNTIME_FILES = (
    ...
    "deploy/windows/gpup/VMate.GpuP.OfflineDriverPackage.ps1",
    ...
    "deploy/windows/gpup/VMate.GpuP.ClientInventory.ps1",
    ...
    "deploy/windows/gpup/VMate.HyperV.RdpConnection.ps1",
    ...
    "deploy/windows/gpup/VMate.HyperV.GpuPColdStartIsolation.ps1",
    "deploy/windows/gpup/VMate.P11.ColdStartArtifacts.ps1",
    "deploy/windows/gpup/VMate.P11.EspBootManager.ps1",
    "deploy/windows/gpup/VMate.P11.HostEnvironment.ps1",
    ...
    "deploy/windows/gpup/VMate.GpuP.GuestDeviceReality.ps1",
    ...
    "deploy/windows/gpup/Open-VMateGpuPRdp.ps1",
