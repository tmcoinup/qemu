...
/*
 * deploy stealth: pose as Realtek (0x10ec) instead of Red Hat / virtio
 * (0x1af4). Together with the PCI controller FriendlyName rewrite in
 * apply-gpu-spoof.ps1 this prevents GPU-Z / driverquery from linking
 * the audio codec vendor ID back to QEMU virtio.
 */
