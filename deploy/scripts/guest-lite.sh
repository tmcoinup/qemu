#!/usr/bin/env bash
# One-command build/hot-mount wrapper for G-11 Windows 10 Guest Lite 2.6.8.
set -euo pipefail
umask 077
...
G11GuestLite.exe. Version 2.6.8 covers microphone privacy access disabled,
Defender/firewall, notifications,
